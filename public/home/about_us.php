            ...
            <ul>
                ...
                <?php
						if(!isset($_SESSION["active"])){echo '<a href="book_now.php"><button class="btn1" id="btn1">RENT NOW</button></a>';}
							...
							if($_SESSION["active"] == "admin"){echo '<a href="bookings.php"><button class="btn1" id="btn1">BOOKINGS</button></a>';}
            ...
            <div class="our_team">
                <div class="team_member">
                    <div class="member_img">
                        <img src="Assets/image/pic-dexter.png" alt="our_team">
                    </div>
                ...
                <div class="team_member">
                    <div class="member_img">
                        <img src="Assets/image/pic-jm.jpg" alt="our_team">
                    </div>
