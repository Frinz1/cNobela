            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="div-center">
                        <h1 class="font_size">Update Featured</h1>
                        <form action="{{url('/update_featured_confirm',$featured->id)}}" method="POST"
                            ...
                            <div class="div_design">
                                ...
                                <select class="text_color" type="text" name="featured_genre"
                                    ...
                                    <option value="{{$featured->featured_genre}}" selelected="">
                                        {{$featured->featured_genre}}
                                    </option>
